...
void ArithVariables::pushUpperBound(ArithVar v, Constraint c){
  d_ubRevertHistory.push_back(make_pair(v,c));
}
void ArithVariables::pushLowerBound(ArithVar v, Constraint c){
  d_lbRevertHistory.push_back(make_pair(v,c));
}
